...
This guide helps you diagnose and resolve common issues with the PulumiCost Vantage plugin.
...
4. Consider using Cost Report tokens instead of Workspace tokens for better rate limits
...
- `adapter=vantage operation=costs attempt=1` - Normal operations
